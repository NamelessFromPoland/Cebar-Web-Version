...
/** @type {string} */
const CACHE_VERSION = '1785948134|750397101';
/** @type {string} */
const CACHE_PREFIX = 'Cebar-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Cebar.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Cebar.html","Cebar.js","Cebar.offline.html","Cebar.icon.png","Cebar.apple-touch-icon.png","Cebar.audio.worklet.js","Cebar.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Cebar.wasm","Cebar.pck","Cebar.side.wasm"];
